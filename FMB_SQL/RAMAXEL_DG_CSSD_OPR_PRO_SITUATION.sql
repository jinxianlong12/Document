...
BASIC_TEMP AS (
                SELECT 2 SEQ,'消费级SSD' TYPE,1 OPER_SEQ,'140060' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,2 OPER_SEQ,'140070' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,3 OPER_SEQ,'140080' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,4 OPER_SEQ,'140270' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,5 OPER_SEQ,'140280' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,6 OPER_SEQ,'140290' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,7 OPER_SEQ,'150010' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,8 OPER_SEQ,'160010' OPER FROM DUAL
                UNION ALL
                SELECT 2 SEQ,'消费级SSD' TYPE,9 OPER_SEQ,'180010' OPER FROM DUAL
               )
SELECT
      A.*,
      B.OPER_DESC,
